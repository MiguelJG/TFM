    ...
    xmlhttp.onreadystatechange = function() {
      if (this.readyState == 4 && this.status == 200) {
        if (this.responseText == "208") {
          document.getElementById("main").innerHTML = "<div class='error'>Error 208, usuario o clave inválido </div>" + '<img alt="" src="./img/innvaliduser.png" width=100 height=100>';
        } else{
  ...
  xmlhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      if (this.responseText == "208") {
        ...
        table += "</table>"
        let documentacion = "<div class='DocIA'>";
        let tipriesgo = "";
        for(let i = 0; i < info.length; i++){
          if(i == 5){
            if(info[i] == "1"){
              tipriesgo += '<img alt="Riesgo intolerable" src="./img/riesg1.png" width=10" height="10">';
            }else if(info[i] == "2"){
              tipriesgo += '<img alt="Riesgo Elevado" src="./img/riesg2.png" width=10" height="10">';
            } else if(info[i] == "3"){
              tipriesgo += '<img alt="Riesgo Medio" src="./img/riesg3.png" width=10" height="10">';
            } else if(info[i] == "4"){
              tipriesgo += '<img alt="Riesgo mínimo" src="./img/riesg4.png" width=10" height="10">';
            }else{
              tipriesgo += '<img alt="otros Riesgos" src="./img/riesgother.png" width=10" height="10">';
            }
          }else if(i == 0){
        ...
        documentacion += "</div>";
        document.getElementById("main").innerHTML = name +documentacion + table + tipriesgo + confusion + back;
      }
